...
class ElasticsearchApplicationTests {
	...
	void testAddDocument() throws IOException {
		// 创建对象
		User user = User.valueOf("林裕恒", 3);
		// 创建请求
		IndexRequest request = new IndexRequest("lyh_index");
		// 规则 put /lyh_index/_doc/1
		request.id("1");
	...
	void testBulkRequest() throws IOException {
		...
		userList.add(User.valueOf("lyh1",3));
		userList.add(User.valueOf("lyh2",3));
		userList.add(User.valueOf("lyh3",3));
		userList.add(User.valueOf("qinjiang1",3));
		userList.add(User.valueOf("qinjiang1",3));
		userList.add(User.valueOf("qinjiang1",3));
		// 批处理请求
	...
	void testSearch() throws IOException {
		SearchRequest searchRequest = new SearchRequest("lyh_index");
		// 构建搜索条件
